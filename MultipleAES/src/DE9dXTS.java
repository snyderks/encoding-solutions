    ...
    void decrypt(){
        ...
        while ((len = readBlock()) >= 0){
            if (len == blockSize){
                ...
                // copy lastBlock to state
                // do XTS-AES block decryption (xdx)
                // save state in lastBlock
                // copy the first len bytes of currentBlock to state
                // copy lastT to T
                // do XTS-AES block decryption
