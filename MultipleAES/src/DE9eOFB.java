// DE9eOFB.java CS6025 Cheng 2016
// Implementing AES encryption with OFB mode
// Usage: java DE9eOFB key nonce < original > DE9testOFB.de9
...
public class DE9eOFB{
    ...
    void encrypt(String[] args){
        if (args.length > 2) {
            try {
                ...
                // file output
                stream = new FileOutputStream("decryptedOFB.de9", false);
    ...
    public static void main(String[] args){
        if (args.length < 2){
            System.err.println("Usage: java DE9eOFB key nonce < original > DE9testOFB.de9");
            return;
        }
        DE9eOFB de9 = new DE9eOFB();
        de9.makeLog();
        de9.buildS();
        de9.readKey(args[0]);
        de9.expandKey();
