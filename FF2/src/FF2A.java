// FF2A.java CS6025 Cheng 2017
// Implementing FF2 encryption
// Usage: java FF2A key string
...
public class FF2A{
    ...
    private static final int logBase = 3;
    ...
    private static final byte[] B = new byte[] { 0, 1, 1, 0, 0, 0, 1, 1};
    ...
    private int[] alog = new int[fieldSize];
    private int[] log = new int[fieldSize];
    private int[] S = new int[fieldSize];
    static final int blockSize = 16;
    private static final int numberOfRounds = 11;
    int[] state = new int[blockSize];
    private int[][] roundKey = new int[numberOfRounds][blockSize];
    ...
    private int logMultiply(int a, int b){
    ...
    void FF2rounds(){  // step 5 of Algorithm FF2, Figure 7.15
        ...
        void encrypted(){
            for (int i = 0; i < XA.length; i++) System.out.print((char)(XA[i] + 'a'));
            for (int i = 0; i < XB.length; i++) System.out.print((char)(XB[i] + 'a'));
        System.out.println();
    }
